...
import { calculerScoreConfiance } from "@/modules/score";
import { ProfilFiscalComplete } from "@/modules/profil/types";

/**
 * GET /api/score/confiance
 * Récupère le détail du score de confiance
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const scoreConfiance = calculerScoreConfiance(profil);

    return NextResponse.json(scoreConfiance);
  } catch (error) {
